...
void ApplyMenuTheme(int theme) {
  ...
  if (theme == 0) { // Midnight
    ...
    colors[ImGuiCol_PopupBg] = ImVec4(0.05f, 0.06f, 0.08f, 0.97f);
    colors[ImGuiCol_Border] = ImVec4(0.16f, 0.20f, 0.25f, 0.40f);
    colors[ImGuiCol_FrameBg] = ImVec4(0.10f, 0.12f, 0.16f, 0.85f);
    colors[ImGuiCol_FrameBgHovered] = ImVec4(0.14f, 0.18f, 0.22f, 0.95f);
    colors[ImGuiCol_FrameBgActive] = ImVec4(0.16f, 0.22f, 0.27f, 1.00f);
    colors[ImGuiCol_TitleBg] = ImVec4(0.04f, 0.05f, 0.07f, 1.00f);
    colors[ImGuiCol_TitleBgActive] = ImVec4(0.05f, 0.06f, 0.08f, 1.00f);
    colors[ImGuiCol_Button] = ImVec4(0.14f, 0.51f, 0.74f, 1.00f);
    colors[ImGuiCol_ButtonHovered] = ImVec4(0.20f, 0.61f, 0.85f, 1.00f);
    colors[ImGuiCol_ButtonActive] = ImVec4(0.10f, 0.42f, 0.63f, 1.00f);
    colors[ImGuiCol_Header] = ImVec4(0.14f, 0.51f, 0.74f, 0.30f);
    colors[ImGuiCol_HeaderHovered] = ImVec4(0.20f, 0.61f, 0.85f, 0.42f);
    colors[ImGuiCol_HeaderActive] = ImVec4(0.20f, 0.61f, 0.85f, 0.56f);
    colors[ImGuiCol_SliderGrab] = ImVec4(0.27f, 0.73f, 0.86f, 1.00f);
    colors[ImGuiCol_SliderGrabActive] = ImVec4(0.40f, 0.83f, 0.93f, 1.00f);
    colors[ImGuiCol_CheckMark] = ImVec4(0.27f, 0.73f, 0.86f, 1.00f);
    colors[ImGuiCol_Text] = ImVec4(0.93f, 0.95f, 0.97f, 1.00f);
    colors[ImGuiCol_TextDisabled] = ImVec4(0.49f, 0.55f, 0.62f, 1.00f);
    colors[ImGuiCol_Separator] = ImVec4(0.16f, 0.20f, 0.25f, 0.60f);
    colors[ImGuiCol_SeparatorHovered] = ImVec4(0.20f, 0.61f, 0.85f, 0.70f);
    colors[ImGuiCol_ScrollbarBg] = ImVec4(0.04f, 0.05f, 0.07f, 0.80f);
    colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.16f, 0.20f, 0.25f, 0.85f);
    colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.22f, 0.29f, 0.36f, 0.95f);
    colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.20f, 0.61f, 0.85f, 1.00f);
    colors[ImGuiCol_Tab] = ImVec4(0.08f, 0.10f, 0.13f, 0.85f);
    colors[ImGuiCol_TabHovered] = ImVec4(0.20f, 0.61f, 0.85f, 0.55f);
    colors[ImGuiCol_TabActive] = ImVec4(0.11f, 0.14f, 0.18f, 1.00f);
    colors[ImGuiCol_PlotHistogram] = ImVec4(0.27f, 0.73f, 0.86f, 1.00f);
    colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.40f, 0.83f, 0.93f, 1.00f);
    colors[ImGuiCol_NavHighlight] = ImVec4(0.20f, 0.61f, 0.85f, 0.80f);
